    ...
    <footer className="mt-16 border-t border-[var(--border)] bg-[#f7f8fa]">
      <div className="container grid gap-8 py-12 md:grid-cols-[2fr,1fr,1fr]">
        <div className="space-y-3">
          <p className="text-xl font-extrabold text-slate-900">۲۰۲۰نیوز</p>
        ...
        <div>
          <p className="text-sm font-semibold text-slate-900">دسترسی سریع</p>
      ...
      <div className="border-t border-[var(--border)] bg-white py-4">
        <div className="container flex flex-col items-center gap-3 text-center text-xs text-slate-600 sm:flex-row sm:justify-between">
          ...
          <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-4">
            ...
            <a href="https://e-rasaneh.ir/Certificate/87565" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-slate-600">
              <Image
