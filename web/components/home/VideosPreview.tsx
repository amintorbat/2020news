    ...
    <section className={cn(container && "container", "space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-4", className)} dir="rtl">
      <div className="w-full rounded-xl sm:rounded-2xl md:rounded-3xl border border-[var(--border)] bg-white shadow-card p-2.5 sm:p-3 md:p-4 space-y-2.5 sm:space-y-3 md:space-y-4 overflow-hidden">
        <div className="flex items-center justify-between">
          <h2 className="text-sm sm:text-base md:text-lg font-bold text-slate-900 lg:text-base" style={{ color: '#0f172a' }}>ویدیوهای جدید</h2>
        </div>
        ...
        {filteredVideos.length > 0 ? (
          <div className="relative -mx-2.5 sm:-mx-3 md:-mx-4 lg:mx-0 px-2.5 sm:px-3 md:px-4 lg:px-0">
            <Swiper
              ...
              className="videos-swiper [&_.swiper-pagination]:static [&_.swiper-pagination]:mt-2 [&_.swiper-pagination-bullet]:w-1 [&_.swiper-pagination-bullet]:h-1 sm:[&_.swiper-pagination]:mt-3 sm:[&_.swiper-pagination-bullet]:w-1.5 sm:[&_.swiper-pagination-bullet]:h-1.5 md:[&_.swiper-pagination]:mt-4"
              dir="rtl"
            >
